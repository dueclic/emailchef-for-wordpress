...
<div class="ecf-main-container">
    <div class="ecf-main-account">
        <h2>Emailchef account</h2>
        <div class="ecf-account-status">
            <div class="ecf-account-connected"></div>
            <div><strong>Account connected</strong></div>
        </div>
        <div class="ecf-account-info">
            <span class="flex-grow-1 truncate" title="alessandro@sendblaster.com">alessandro@sendblaster.com</span>
            <span>
                <a id="emailchef-disconnect" class="ecf-account-disconnect" title="Disconnect Account">
