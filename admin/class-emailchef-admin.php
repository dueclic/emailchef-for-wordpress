...
class Emailchef_Admin {
	...
	public function page_options_settings_section_callback() {
		echo sprintf( __( 'Please provide same login information used to login in <a target="_blank" href="%s">emailchef.com</a> website. Or <a target="_blank" href="%s">click here</a> to try it for free.', 'emailchef' ), 'http://emailchef.com/', 'https://app.emailchef.com/customer/signup?lang=en&type=RECURRING' );
	}
